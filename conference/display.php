...
if($dept=="null")
{
  ...
  $sql="SELECT * ,GROUP_CONCAT(author_details.auth_name ORDER BY author_details.auth_sno ASC SEPARATOR ',') FROM conference, faculty,author_details WHERE faculty.eid=author_details.auth_id AND conference.aid =author_details.aid AND faculty.dept='$dept' GROUP BY author_details.aid";
...
<th scope='col' class='table-secondary'>Name of the Conference</th>
...
while($row=$result->fetch_assoc())
  ...
  echo "<td class='table-secondary'>" . $row['Conference_Name'] . "</td>";
